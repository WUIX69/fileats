...
<head>
	...
	<style>
		section#center {
			background-image: url(../../../../public/assets/img/contents/heroes/blog.jpg);
		}
	</style>
</head>
							...
							<div class="blog_1_left">
								<div class="blog_1_left1">
									<a href="single-view.html"><img
											src="../../../../public/assets/img/contents/others/gal-2.jpg"
								...
								<div class="blog_1_left1 mt-4">
									<a href="single-view.html"><img
											src="../../../../public/assets/img/contents/others/busog-sarap.jpg"
											class="img-fluid" alt="abc"></a>
									<div class="blog_1_left1_inner p-3 shadow">
										<div class="blog_1_left1_inner1 p-4 box border_light">
								...
								<div class="blog_1_left1 mt-4">
									<a href="single-view.html"><img
											src="../../../../public/assets/img/contents/others/gal-1.jpg"
											class="img-fluid" alt="abc"></a>
									<div class="blog_1_left1_inner p-3 shadow">
										<div class="blog_1_left1_inner1 p-4 box border_light">
						...
						<div class="col-md-4 col-lg-3">
							<div class="blog_1_right">
								<div class="blog_1_right1">
									...
									<a href="single-view.html"><img
											src="../../../../public/assets/img/contents/others/pasto-pizza.jpg"
											class="img-fluid" alt="abc"></a>
