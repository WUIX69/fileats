...
<head>
    ...
    <?= featured('users/recipe-submit/styles'); ?>
</head>
...
<body>
            ...
            <section id="recipe">
                <div class="container-xl">
                    <div class="row justify-content-center">
                        <!-- Recipe Form -->
                        <div class="col-lg-8">
                            <?= featured('users/recipe-submit/components/recipe-form'); ?>
                        </div>
                        <!-- FAQs -->
                        <div class="col-lg-4">
                            <?= featured('users/recipe-submit/components/submission-faqs'); ?>
                        </div>
                    </div>
                </div>
            </section>
    ...
    <?= featured('users/recipe-submit/scripts'); ?>
