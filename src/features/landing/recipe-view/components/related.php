            ...
            <div class="recipe_1_left2o1">
                <div class="recipe_1_left2_inner_left position-relative">
                    ...
                    <div class="recipe_1_left2_inner_left2 position-absolute top-0 text-end p-3 w-100">
                        <h6 class="mb-0 font_14"><a class="d-inline-block bg_green p-2 text-white px-4 tag-box2"
                                href="#">Vegan</a></h6>
                    </div>
                </div>
                <div class="recipe_1_left2o1i p-2 shadow">
                    <div class="recipe_1_left2o1i1 p-3 border_light box">
                        ...
                        <span class="font_14"> <i class="bi bi-person-fill col_green me-1 fs-6 align-middle"></i>
