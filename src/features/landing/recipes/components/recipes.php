                    ...
                    <div class="recipe_1_left2 mt-4">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="profile1">
                                            ...
                                            <div class="recipe_1_left2_inner_left position-relative">
                                                ...
                                                <div
                                                    ...
                                                    <h6 class="mb-0 font_14"><a
                                                            class="d-inline-block bg_green p-2 text-white px-4"
                                ...
                                <div class="recipe_1_left2o row row-cols-1 row-cols-md-3 mt-4">
                                    <div class="col">
                                        <div class="recipe_1_left2o1">
                                            <div class="recipe_1_left2_inner_left position-relative">
                                                <div class="recipe_1_left2_inner_left1">
                                ...
                                <div class="recipe_1_left2_inner row mt-4">
                                    <div class="col-md-4 pe-0">
                                        <div class="recipe_1_left2_inner_left position-relative">
                                            <div class="recipe_1_left2_inner_left1">
                                                <a href="single-view.html"><img
                                                        src="../../../../../public/assets/img/contents/menus/dinner/seafood.jpg"
                                                        class="img-fluid" alt="abc"></a>
                                            </div>
                                            <div
                                                class="recipe_1_left2_inner_left2 position-absolute top-0 text-end p-3 w-100">
                ...
                <div class="recipe_1_right">
                    <div class="recipe_1_right1">
                        ...
                        <ul class="mb-0 recipes-downward-fmt">
                            ...
                            <li class="d-flex">
                                <span><a href="single-view.html"><img width="100" alt="abc"
                                            src="../../../../../public/assets/img/contents/menus/dinner/inasal.jpg"></a></span>
                                <span class="flex-column ms-3">
                    ...
                    <div class="recipe_1_right1 mt-5">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control font_12" placeholder="Your Email address...">
