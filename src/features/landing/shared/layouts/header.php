            ...
            <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
                ...
                <div class="offcanvas-body pt-0 align-items-center">
                    <ul class="navbar-nav align-items-lg-center ms-auto mt-2">
                        <li class="nav-item">
                            <a class="nav-link active fs-4 mt-1" href="index.html" title="Visit home page">
                        ...
                        <li class="nav-item dropdown drop_border">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                Recipes<img src="../../../public/assets/img/icons-svg/chevron-down.svg" width="15"
                        ...
                        <li class="nav-item dropdown drop_border">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                Blog<img src="../../../public/assets/img/icons-svg/chevron-down.svg" width="15"
                                    height="15" alt="Submenu open/close icon">
                            </a>
                            <ul class="dropdown-menu drop_1 shadow" aria-labelledby="navbarDropdown">
                        ...
                        <li class="nav-item dropdown drop_border">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                Pages<img src="../../../public/assets/img/icons-svg/chevron-down.svg" width="15"
                                    height="15" alt="Submenu open/close icon">
                            </a>
                            <ul class="dropdown-menu drop_1 shadow" aria-labelledby="navbarDropdown">
                    ...
                    <ul class="navbar-nav align-items-lg-center ms-auto mt-2">
                        <li class="nav-item">
                            <a class="nav-link submit-recipe-btn button" href="../auth/index.html"
                                title="Submit Recipe">
                                Submit Recipe
                            </a>
                        </li>
