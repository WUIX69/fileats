            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="tab-content p-4 card-body">
                        <!-- Profile Settings -->
                        <?= featured('users/settings/components/tab/profile'); ?>

                        <!-- Account Settings -->
                        <?= featured('users/settings/components/tab/account'); ?>

                        <!-- Notification Settings -->
                        <?= featured('users/settings/components/tab/notification'); ?>

                        <!-- Preferences Settings -->
                        <?= featured('users/settings/components/tab/preferences'); ?>
                    </div>
                </div>
            </div>
        </div>
