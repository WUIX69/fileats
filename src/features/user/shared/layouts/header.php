                    ...
                    <ul class="navbar-nav align-items-lg-center ms-auto mt-2">
                        <li class="nav-item">
                            <a class="nav-link <?= ($activeLink === 'index' || $activeLink === '') ? 'active' : '' ?>"
                                href="<?= app('user'); ?>" title="Visit home page">
                                Dashboard
                            </a>
                        </li>
                        <li class="nav-item dropdown drop_border">
                            ...
                            <ul class="dropdown-menu drop_1 shadow" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?= app('user/discover/recipes'); ?>">Discover
                                        Recipes</a></li>
                                <li><a class="dropdown-item border-0" href="<?= app('user/discover/chefs'); ?>">
                                        Discover
                                        Chefs</a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $activeLink === 'bookmarks' ? 'active' : '' ?>"
                                href="<?= app('user/bookmarks'); ?>" title="Visit Bookmarked recipes">
                                Bookmarks
                            </a>
                        </li>
                        <li class="nav-item dropdown drop_border">
                            <a class="nav-link dropdown-toggle <?= $activeLink === 'recipe' ? 'active' : '' ?>" href="#"
                                ...
                                Manage Recipes<img src="<?= asset('img/icons-svg/chevron-down.svg'); ?>" width="15"
                                    height="15" alt="Submenu open/close icon">
                            </a>
                            <ul class="dropdown-menu drop_1 shadow" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?= app('user/recipe/submit'); ?>"> Submit a
                                        Recipe</a></li>
                                <li><a class="dropdown-item border-0" href="<?= app('user/recipe/mine'); ?>"> My
                                        Recipes</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $activeLink === 'settings' ? 'active' : '' ?>"
                                href="<?= app('user/settings'); ?>" title="Visit Settings">
                                Settings
                            </a>
                        </li>
                    </ul>
                    <ul class="navbar-nav align-items-lg-center ms-auto mt-2 gap-2 right-end">
                        ...
                        <li class="nav-item dropdown drop_border">
                            <div class="user-greeting d-flex align-items-center">
                                <div class="profile">
                                    <img src="<?= asset('img/members/jack.jpg'); ?>" class="rounded-circle me-2"
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false"><img
                                    src="<?= asset('img/icons-svg/chevron-down.svg'); ?>" width="15" height="15"
                                    alt="Submenu open/close icon">
                            </a>
                            <ul class="dropdown-menu drop_1 shadow" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?= app('user'); ?>"> Dashboard</a></li>
                                <li><a class="dropdown-item" href="<?= app('user/settings'); ?>">
                                        Settings</a>
                                </li>
